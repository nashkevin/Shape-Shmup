...
public class ProjectileTest {
	...
	public void test_constructor() {
		...
		Projectile projectile = null;//new ProjectileTestImp(env, owner, position, velocity);
		...
		try {
			projectile = null;//new ProjectileTestImp(null, owner, position, velocity);
			Assert.fail();
		} catch (Exception e) {}

		// TEST CASE: Null owner
		try {
			projectile = null;//new ProjectileTestImp(env, null, position, velocity);
			Assert.fail();
		} catch (Exception e) {}

		// TEST CASE: Null position
		try {
			projectile = null;//new ProjectileTestImp(env, owner, null, velocity);
			Assert.fail();
		} catch (Exception e) {}

		// TEST CASE: Null velocity
		try {
			projectile = null;//new ProjectileTestImp(env, owner, position, null);
			Assert.fail();
		} catch (Exception e) {}
	}
